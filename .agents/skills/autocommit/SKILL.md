---
name: autocommit
description: Creates semantic Git commits from all available changes, grouping files by purpose and following Conventional Commits format. Use via /autocommit command.
license: MIT
metadata:
  author: bryan
